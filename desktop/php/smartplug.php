...
sendVarToJS('eqType', 'smartplug');
$eqLogics = eqLogic::byType('smartplug');
...
<div class="row row-overflow">
        	...
        	<span style="font-size : 1.1em;position:relative; top : 15px;word-break: break-all;white-space: pre-wrap;word-wrap: break-word;"><center>Ajouter</center></span>
                ...
                foreach ($eqLogics as $eqLogic) {
                  ...
                  echo "<center>";
                    ...
                    echo '<img src="plugins/smartplug/doc/images/' . $path . '.png" height="105" width="95" />';
                    echo "</center>";
        ...
        <div class="row">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label">{{Ampoule smartplug}}</label>
                    <div class="col-md-3">
                        <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
                        <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement smartplug}}"/>
                    </div>
                </div>
                <div class="form-group">
	...
	<legend><i class="fa fa-table"></i>  {{Commandes smartplug}}</legend>
...
<?php include_file('desktop', 'smartplug', 'js', 'smartplug'); ?>
